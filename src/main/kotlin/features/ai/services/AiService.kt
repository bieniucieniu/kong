...
//    )
    ...
    fun getService(provider: String? = null): AiProviderService? =
        (services.find { it.provider.id == provider } ?: getDefaultService())

    fun getDefaultService(): AiProviderService? = services.firstOrNull()
