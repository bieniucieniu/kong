 ...
 * Chat with AI
 */
export type postApiAiChatFreeWithJsonResponse503 = {
	data: ErrorResponse;
	status: 503;
};
export type postApiAiChatFreeWithJsonResponseError =
	postApiAiChatFreeWithJsonResponse503 & {
		headers: Headers;
	};

export type postApiAiChatFreeWithJsonResponse =
	postApiAiChatFreeWithJsonResponseError;

export const getPostApiAiChatFreeWithJsonUrl = () => {
	return `/api/ai/chat/free`;
};

export const postApiAiChatFreeWithJson = async (
	chatPromptsList: ChatPromptsList,
	options?: RequestInit,
): Promise<postApiAiChatFreeWithJsonResponse> => {
	...
	if (!res.ok) {
		const err: globalThis.Error & {
			info?: postApiAiChatFreeWithJsonResponseError["data"];
			status?: number;
		} = new globalThis.Error();
		const data: postApiAiChatFreeWithJsonResponseError["data"] = body
			? JSON.parse(body)
			: {};
		err.info = data;
		err.status = res.status;
	...
	const data: postApiAiChatFreeWithJsonResponse["data"] = body
		? JSON.parse(body)
		: {};
	return {
		data,
		status: res.status,
		headers: res.headers,
	} as postApiAiChatFreeWithJsonResponse;
};

export const getPostApiAiChatFreeWithJsonMutationOptions = <
	TError = ErrorResponse,
	TContext = unknown,
>(options?: {
	mutation?: UseMutationOptions<
		Awaited<ReturnType<typeof postApiAiChatFreeWithJson>>,
		TError,
	...
	TContext
> => {
	const mutationKey = ["postApiAiChatFreeWithJson"];
	const { mutation: mutationOptions, fetch: fetchOptions } = options
		? options.mutation &&
			"mutationKey" in options.mutation &&
			options.mutation.mutationKey
	...
	> = (props) => {
		...
		return postApiAiChatFreeWithJson(data, fetchOptions);
	};

	return { mutationFn, ...mutationOptions };
};

export type PostApiAiChatFreeWithJsonMutationResult = NonNullable<
	Awaited<ReturnType<typeof postApiAiChatFreeWithJson>>
>;
export type PostApiAiChatFreeWithJsonMutationBody = ChatPromptsList;
export type PostApiAiChatFreeWithJsonMutationError = ErrorResponse;

export const usePostApiAiChatFreeWithJson = <
	TError = ErrorResponse,
	TContext = unknown,
>(
	options?: {
...
> => {
	return useMutation(
		getPostApiAiChatFreeWithJsonMutationOptions(options),
		queryClient,
	);
};
 ...
 * Chat with AI
 */
export type postApiAiChatFreeWithUrlEncodedResponse503 = {
	data: ErrorResponse;
	status: 503;
};
export type postApiAiChatFreeWithUrlEncodedResponseError =
	postApiAiChatFreeWithUrlEncodedResponse503 & {
		headers: Headers;
	};

export type postApiAiChatFreeWithUrlEncodedResponse =
	postApiAiChatFreeWithUrlEncodedResponseError;

export const getPostApiAiChatFreeWithUrlEncodedUrl = () => {
	return `/api/ai/chat/free`;
};

export const postApiAiChatFreeWithUrlEncoded = async (
	options?: RequestInit,
): Promise<postApiAiChatFreeWithUrlEncodedResponse> => {
	const res = await fetch(getPostApiAiChatFreeWithUrlEncodedUrl(), {
		...options,
		method: "POST",
	});
	...
	if (!res.ok) {
		const err: globalThis.Error & {
			info?: postApiAiChatFreeWithUrlEncodedResponseError["data"];
			status?: number;
		} = new globalThis.Error();
		const data: postApiAiChatFreeWithUrlEncodedResponseError["data"] = body
			? JSON.parse(body)
			: {};
		err.info = data;
		err.status = res.status;
	...
	const data: postApiAiChatFreeWithUrlEncodedResponse["data"] = body
		? JSON.parse(body)
		: {};
	return {
		data,
		status: res.status,
		headers: res.headers,
	} as postApiAiChatFreeWithUrlEncodedResponse;
};

export const getPostApiAiChatFreeWithUrlEncodedMutationOptions = <
	TError = ErrorResponse,
	TContext = unknown,
>(options?: {
	mutation?: UseMutationOptions<
		Awaited<ReturnType<typeof postApiAiChatFreeWithUrlEncoded>>,
		TError,
		void,
		TContext
	>;
	...
	TContext
> => {
	const mutationKey = ["postApiAiChatFreeWithUrlEncoded"];
	const { mutation: mutationOptions, fetch: fetchOptions } = options
		? options.mutation &&
			"mutationKey" in options.mutation &&
			options.mutation.mutationKey
	...
	const mutationFn: MutationFunction<
		...
		void
	> = () => {
		return postApiAiChatFreeWithUrlEncoded(fetchOptions);
	};

	return { mutationFn, ...mutationOptions };
};

export type PostApiAiChatFreeWithUrlEncodedMutationResult = NonNullable<
	Awaited<ReturnType<typeof postApiAiChatFreeWithUrlEncoded>>
>;

export type PostApiAiChatFreeWithUrlEncodedMutationError = ErrorResponse;

export const usePostApiAiChatFreeWithUrlEncoded = <
	TError = ErrorResponse,
	TContext = unknown,
>(
	options?: {
...
> => {
	return useMutation(
		getPostApiAiChatFreeWithUrlEncodedMutationOptions(options),
		queryClient,
	);
};
...
export type getApiAiChatAllResponse401 = {
	data: ErrorResponse;
	status: 401;
};
...
export type getApiAiChatAllResponseError = getApiAiChatAllResponse401 & {
	headers: Headers;
};
